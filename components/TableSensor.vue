...
export default {
    data(){
        return{
            loading: false,
            headerArray: [
                { text: '欄位名稱/相似度', value: 'header', width: '100', align: 'center', divider: true },
                { text: '大氣壓力', value: 'atp', width: '100', align: 'center', divider: true },
                { text: 'EC值', value: 'ec', width: '100', align: 'center', divider: true },
                { text: '濕度', value: 'humidity', width: '100', align: 'center', divider: true },
                { text: '光照', value: 'luminance', width: '100', align: 'center', divider: true },
                { text: 'PH值', value: 'ph', width: '100', align: 'center', divider: true },
                { text: '土壤濕度', value: 'soil_humid', width: '100', align: 'center', divider: true },
                { text: '土壤溫度', value: 'soil_temp', width: '100', align: 'center', divider: true },
                { text: '溫度', value: 'temp', width: '100', align: 'center', divider: true },
                { text: 'UV值', value: 'uv', width: '100', align: 'center', divider: true },
            ],
            page: 1,
            pageCount: 0,
            //datePicker
