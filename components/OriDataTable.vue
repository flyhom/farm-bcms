...
export default {
    data(){
        return{
            ...
            headerArray: [
                { text: '日期', value: 'time'},
                { text: '溫度(°C)', value: 'temp' },
                { text: '濕度(%)', value: 'humidity' },
                { text: '大氣壓力(hPa)', value: 'atp', },
                { text: '光照(Lux)', value: 'luminance' },
                { text: '導電度(uS/cm)', value: 'ec' },
                { text: 'PH值(ph)', value: 'ph' },
                { text: '土壤溫度(°C)', value: 'soil_temp' },
                { text: '土壤濕度(%)', value: 'soil_humid' },
                { text: 'UV值(mw/cm²)', value: 'uv' },
                { text: '雨量(mm)', value: 'rainfall' },
            ],
            page: 1,
            pageCount: 0,
            //datePicker
